...
public class Message {
    ...
    private static ObjectForMessage copyObjectForMessage(ObjectForMessage om){
        if (om==null){return null;}
        List l = om.getData();
        var co = new ObjectForMessage();
        co.setData(l.subList(0,l.size()));
        return co;
    }
    ...
    public static class Builder {
        ...
        public Builder field13(ObjectForMessage field13) {
            ...
            this.field13.setData(new ArrayList<String>(field13.getData()));
            return this;
        }
